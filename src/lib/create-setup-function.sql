-- Create a function to set up a user's subscription with SECURITY DEFINER
-- This will bypass RLS policies and allow the function to create subscriptions for any user
